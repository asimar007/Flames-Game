...
function Strike({ children }) {
  return (
    <span style={{ position: "relative", color: "rgba(200,50,50,0.75)", display: "inline-block" }}>
      {children}
      <svg
        style={{ position: "absolute", left: -1, right: -1, top: "50%", width: "calc(100% + 2px)", height: 10, transform: "translateY(-50%)", overflow: "visible" }}
      >
        <line x1="0" y1="5" x2="100%" y2="4" stroke={red} strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </span>
  );
}
...
export default function DemoPreview() {
  return (
    ...
    >
      ...
      {/* Step 1 */}
      <p style={{ fontFamily: font, fontSize: 12, color: muted, marginBottom: 4 }}>
        Step 1) Cancel common letters:
      </p>
      <div style={{ display: "flex", gap: 8, fontFamily: font, fontSize: 21, fontWeight: 600, letterSpacing: 3, color: ink, marginBottom: 2 }}>
        <Strike>A</Strike>
        <span>S</span>
        <span>I</span>
        <span>M</span>
      </div>
      <div style={{ display: "flex", gap: 8, fontFamily: font, fontSize: 21, fontWeight: 600, letterSpacing: 3, color: ink, marginBottom: 10 }}>
        <span>P</span>
        <Strike>A</Strike>
        <span>Y</span>
        <span>E</span>
      ...
      {/* Step 2 */}
      <p style={{ fontFamily: font, fontSize: 12, color: muted, marginBottom: 2 }}>
      ...
      <div style={{ display: "flex", gap: 10, fontFamily: font, fontSize: 21, fontWeight: 700, letterSpacing: 3, marginBottom: 10 }}>
      ...
      {/* Divider */}
      <hr style={{ border: "none", borderTop: "1px dashed rgba(40,50,80,0.15)", marginBottom: 10 }} />
